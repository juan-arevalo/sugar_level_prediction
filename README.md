...
2. Upload the notebooks to your Google Drive, (for instance, to the path _**My Drive/Colab Notebooks/sugar_level_prediction/explore/**_, but this is not a requirement), and open them with Google Colab (install the App *colaboratory* in your Drive if you haven't done so yet).  
